  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix">
        ...
        <p>
          ...
          <span class="s3" v-show="false">默认地址</span>
        </p>
      </div>
     <!-- <div class="address clearFix">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="(detail,index) in detailArrayList" :key="index">
          <li>
            <img style="width: 100px; height: 100px;" :src="detail.imgUrl" alt="">
          </li>
          <li>
            <p>{{detail.skuName}}</p>
            <h4>7天无理由退货</h4>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收货人：<span>{{defaultUserInfo.consignee}}</span>&emsp;
  ...
  export default {
	...
	methods:{
	    ...
	    async submitOrder(){
			...
			let data = {
				consignee:this.defaultUserInfo.consignee, //付款人的名字
				consigneeTel:this.defaultUserInfo.phoneNum, //付款人的电话
				deliveryAddress:this.defaultUserInfo.fullAddress,//收货人的地址
				paymentWay:'ONLINE',    //支付方式
				orderComment:this.msg,  //用户留言
				orderDetailList:this.detailArrayList  //订单详情
			}
			try{				
			   await this.$store.dispatch('submitOrderInfo',{tradeNo,data}) 	
